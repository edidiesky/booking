              ...
              assignments.map((a) => {
                ...
                return (
                  <tr key={a.id} className="border-b last:border-0 transition-colors hover:bg-[#fafaf9]"
                    ...
                    <td className="px-5 py-3 text-xs lg:text-smfont-mono" style={{ color: "var(--color-muted-stone)" }}>
                      {a.userId}
                    </td>
                    <td className="px-5 py-3">
                      <span className="text-xs lg:text-smpx-2.5 py-1 rounded-full font-medium"
