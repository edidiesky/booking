  ...
  return (
    <form onSubmit={handleSubmit(submit)} className="flex flex-col gap-4">
        ...
        {fields.map((field, i) => (
          <div key={field.id} className="flex items-center gap-3">
            <div className="flex flex-col gap-1 flex-1">
              ...
              <input type="number" className="h-9 border px-3 text-xs lg:text-smoutline-none"
            ...
            <div className="flex flex-col gap-1 flex-1">
              ...
              <input type="number" min={0} max={100}
                     className="h-9 border px-3 text-xs lg:text-smoutline-none"
                     style={{ borderColor: "#e8e6e3", color: "var(--color-ink)" }}
      ...
      <button type="button"
              ...
              className="flex items-center gap-2 text-xs lg:text-smself-start transition-opacity hover:opacity-70"
