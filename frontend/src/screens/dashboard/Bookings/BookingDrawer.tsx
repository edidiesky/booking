      ...
      <DrawerSection label="Room">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-1">
            ...
            <p className="text-xs lg:text-sm text-[#777b86] truncate">
        ...
        <div className="w-full flex items-center justify-end gap-2">
          ...
          {NEXT_STATES[booking.status].map((target) => (
            <button
              ...
              className="text-xs lg:text-sm bold border-[#17191c] border rounded-full px-4 h-8 hover:opacity-90 disabled:opacity-50 transition-opacity"
            >
              {isTransitioning
                ? "Moving..."
