...
export default function PropertyModal({ propertyId, isOpen, onClose }: Props) {
  ...
  const inputClass =
    "h-[42px] border border-[#e8e6e3] px-3 text-xs lg:text-smoutline-none focus:border-[#17191c] transition-colors w-full";
      ...
      >
              ...
              >
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs lg:text-sm text-[#17191c]">
                      Property Name
                    </label>
                    <Input
                      {...register("name")}
                    ...
                    />
                    {errors.name && (
                      <p className="text-xs lg:text-smtext-red-500">
                        {errors.name.message}
                      </p>
                    )}
                  </div>
                  <div className="flex flex-col gap-1.5">
                    <label className="text-xs lg:text-smtext-[#17191c]">
                      Property Type
                    </label>
                    <Controller
                      name="propertyType"
                ...
                {/* address */}
                <div className="flex flex-col gap-1.5">
                  <p className="text-xs lg:text-smtext-[#a3a6af] uppercase tracking-widest ">
                    Address
                  </p>
        ...
        <div className="border-t h-[68px] flex items-center justify-between px-8 shrink-0">
          ...
          <button
            ...
            form="property-form"
            disabled={isBusy}
            className="bg-[#17191c] text-white text-xs lg:text-smpx-6 rounded-full h-9 flex items-center gap-2 hover:opacity-90 disabled:opacity-50 transition-opacity"
          >
            {isBusy
              ? isEdit
                ? "Updating..."
