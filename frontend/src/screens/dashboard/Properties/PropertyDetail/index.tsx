...
export default function PropertyDetail() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center gap-1.5 text-xs lg:text-[13px]  text-[#a3a6af]">
          <button
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6">
          ...
          <div className="w-full flex flex-col gap-7">
            ...
            <table className="w-full text-xs lg:text-[13px]  border rounded-2xl">
              <thead>
          ...
          <div className="flex flex-col gap-4">
            <div className="border border-[#e8e6e3] rounded-xl p-5 flex flex-col gap-3">
              <p className="text-xs lg:text-[13px]  uppercase text-[#a3a6af] bold">
                Details
              </p>
              {[
