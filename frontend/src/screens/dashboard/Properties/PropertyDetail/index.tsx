...
export default function PropertyDetail() {
  ...
  return (
    <>
      ...
      >
        <div className="flex items-center gap-1.5 text-sm lg:text-base text-[#a3a6af]">
          <button
        ...
        <div className="flex items-start justify-between gap-4">
          <div>
            <h4 className="text-2xl bold text-[#17191c]">{property.name}</h4>
            <p className="flex items-center gap-1.5 text-sm lg:text-base text-[#777b86] mt-1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_280px] gap-6">
          ...
          <div className="w-full flex flex-col gap-7">
            <div className="flex items-center justify-between">
              <p className="text-base lg:text-lg bold text-[#17191c]">Units</p>
              <button
                onClick={() => {
                  /* opens CreateRoomTypeModal, wire existing modal here */
                }}
                className="text-sm lg:text-base px-4 py-2 bg-[#17191c] text-white rounded-full hover:opacity-90 transition-opacity flex items-center gap-1.5"
              >
                Add
              </button>
            </div>

            <table className="w-full text-sm lg:text-base border rounded-2xl">
              <thead>
              ...
              <tbody>
                {roomTypes.length === 0 ? (
                  <tr>
                    <td
                      colSpan={5}
                      className="px-5 py-10 text-center text-sm lg:text-base text-[#a3a6af]"
                    >
                      No room types yet.
                    </td>
                  </tr>
                    ...
                    return (
                      ...
                      >
                        <td className="px-5 py-3">
                          ...
                          <p className="text-xs lg:text-sm text-[#a3a6af]">
                            {rt.status ?? "—"}
                          </p>
                        </td>
          ...
          <div className="flex flex-col gap-4">
            <div className="border border-[#e8e6e3] rounded-xl p-5 flex flex-col gap-3">
              ...
              {[
                ...
                <div key={label} className="flex flex-col gap-0.5">
                  <span className="text-xs lg:text-sm text-[#a3a6af]">{label}</span>
                  <span className="text-sm lg:text-base text-[#17191c] bold">{value}</span>
                </div>
              ))}
            </div>
            ...
            <div className="border border-[#e8e6e3] rounded-xl p-5 flex flex-col gap-3">
              ...
              {[
                ...
                <div
                  key={label}
                  className="flex items-center justify-between text-sm lg:text-base"
                >
