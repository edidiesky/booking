          ...
          <div className="w-full px-6 py-5 border-b flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-xs lg:text-sm lg:text-sm text-[#17191c] truncate">{payment.room_type_name}</p>
            ...
            <div className="flex flex-col gap-4 lg:gap-4 lg:w-[75%]">
              {[
                ...
                <div key={label} className="flex items-center justify-between">
                  ...
                  <span className="text-xs lg:text-smtext-[#17191c] bold text-right max-w-[60%] truncate">
                    {value}
                  </span>
                </div>
              ))}
