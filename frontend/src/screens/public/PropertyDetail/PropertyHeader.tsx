      ...
      <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
        <div className="flex flex-col gap-2 flex-1">
          <h1 className="text-3xl md:text-3xl bold text-[#17191c]">
            {property.name}
            <span className="text-xs lg:text-[13px]pt-2 text-[#777b86] font-normal flex items-center gap-3 mt-1">
        ...
        <span className="text-xs lg:text-[13px]px-3 py-1 bold rounded-full capitalize self-start"
