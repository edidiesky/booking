    ...
    <div className="fixed inset-0 bg-black/40 backdrop-blur-sm p-4 flex items-center justify-end z-50">
      ...
      >
        <div className="border-b border-[#e8e6e3] flex items-center justify-between px-8 h-[72px] shrink-0">
          <h4 className="text-xs bold text-[#17191c]">{data?.data.tenant.name ?? "Tenant"}</h4>
        ...
        {isLoading || !data ? (
          ...
          <div className="flex-1 overflow-y-auto px-8 py-6 flex flex-col gap-8">
            <section>
              <p className="text-xs bold mb-3" style={{ color: "var(--color-ink)" }}>Profile</p>
            ...
            <section>
              <p className="text-xs bold mb-3" style={{ color: "var(--color-ink)" }}>At a glance</p>
            ...
            <section>
              <p className="text-xs bold mb-3" style={{ color: "var(--color-ink)" }}>Recent purchases</p>
            ...
            <section>
              <p className="text-xs bold mb-3" style={{ color: "var(--color-ink)" }}>Recent activity</p>
