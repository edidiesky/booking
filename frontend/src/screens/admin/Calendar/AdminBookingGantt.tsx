...
import { useAdminIncrementalBookingWindow } from "./hooks/useAdminIncrementalBookingWindow";
import BookingBar from "@/components/dashboard/common/gant/BookingBar";
import MultiSelectDropdown from "@/components/dashboard/common/gant/MultiSelectDropdown";
interface Props {
  onSelectBooking: (bookingId: string) => void;
}
export default function AdminBookingGantt({ onSelectBooking }: Props) {
...
// and this one call changed:
const { bookings, loadedDays, loadingMore, reachedCap, loadMore } = useAdminIncrementalBookingWindow({
