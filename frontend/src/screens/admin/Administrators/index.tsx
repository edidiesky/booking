  ...
  return (
    ...
    >
      ...
      <div className="border border-[#e8e6e3] rounded-xl p-5 flex flex-col gap-5 w-fit min-w-[220px]">
        <p className="text-xs lg:text-sm uppercase text-[#a3a6af]">Total</p>
        <p className="text-xl lg:text-4xl bold text-[#17191c]">{totalCount}</p>
        <p className="text-xs lg:text-sm medium text-[#a3a6af]">Active platform administrator accounts</p>
      </div>
