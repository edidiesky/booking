      ...
      >
        ...
        <div className="w-full flex px-8 py-4 border-t border-[#e8e6e3] bg-white items-center justify-end gap-3">
          <button
            ...
            onClick={onClose}
            disabled={isLoading}
            className="h-9 px-5 text-xs lg:text-smrounded-full text-[#4c4c4c] border border-[#e8e6e3] hover:bg-[#f2f0ed] transition-colors disabled:opacity-50"
          >
            Keep booking
          </button>
          <button
            ...
            disabled={isLoading}
            className="h-9 px-5 text-xs lg:text-smrounded-full bg-red-600 text-white hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center gap-2"
          >
            {isLoading ? (
              <>
