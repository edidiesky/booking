          ...
          {hasBookings && (
            <div className="flex items-center justify-between gap-4">
              <h3 className="text-3xl flex-1 md:text-3xl bold text-[#17191c]">
                My Reservations
                <span className="block pt-3 font-normal text-xs lg:text-smmd:text-xs lg:text-sm text-[#4c4c4c]">
          ...
          {isLoading ? (
            ...
            <div className="w-full flex flex-col gap-4 justify-center items-center py-12">
              ...
              <div className="flex flex-col w-full gap-3 justify-center items-center">
                ...
                <Link
                  to="/properties"
                  className="text-xs lg:text-smmd:text-xs lg:text-smfont-normal pb-1 pt-3 w-fit border-b border-[#17191c] uppercase tracking-wider text-[#17191c]"
                >
