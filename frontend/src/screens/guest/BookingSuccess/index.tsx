          ...
          <>
            ...
            {booking.receiptUrl && (
              <a href={booking.receiptUrl} target="_blank" rel="noopener noreferrer"
                className="text-xs lg:text-sm text-center underline underline-offset-4 text-[#777b86] hover:text-[#17191c] transition-colors">
                View receipt
              </a>
            )}
            ...
            {booking.propertyName && (
              ...
              >
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-[#17191c] text-white flex items-center justify-center text-xs lg:text-sm shrink-0">
