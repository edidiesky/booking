  ...
  return (
    <form onSubmit={handleSubmit(handleSave)} className="flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-1.5">
        <label className="text-xs lg:text-[13px]   font-medium" style={{ color: "var(--color-ink)" }}>Bio</label>
        <textarea
          rows={3}
      ...
      <button
        ...
        className="w-full h-11 rounded-full text-xs lg:text-[13px]   transition-opacity hover:opacity-80 disabled:opacity-50"
