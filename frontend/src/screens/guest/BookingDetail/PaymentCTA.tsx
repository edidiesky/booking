  ...
  return (
    <div className="w-full flex flex-col gap-4 lg:gap-8">
      <div className="flex gap-3">
        {(["paystack", "flutterwave"] as const).map((g) => (
          <button
            ...
            className={`w-40 h-11 border rounded-full text-xs lg:text-smcapitalize transition-colors ${
      ...
      <button
        ...
        className="h-12 rounded-full px-8 text-xs lg:text-sm lg:text-sm uppercase text-center text-white bg-[#17191c] hover:opacity-90 disabled:opacity-50 transition-opacity"
      >
