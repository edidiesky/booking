  ...
  return (
    <div className="w-full flex flex-col gap-4 lg:gap-8">
      ...
      <button
        ...
        className="h-12 rounded-full px-8 text-xs lg:text-sm uppercase text-center text-white bg-[#17191c] hover:opacity-90 disabled:opacity-50 transition-opacity"
      >
