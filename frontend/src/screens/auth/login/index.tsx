      ...
      >
        ...
        <div ref={fieldsRef} className="flex flex-col gap-4">
          <button
            ...
            className="w-full h-12 flex items-center justify-center gap-2 text-xs lg:text-sm bold rounded-xl border transition-colors bg-[#fff] hover:bg-[#f2f0ed]"
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full h-12 flex items-center justify-center lg:text-sm text-xs bold rounded-full transition-opacity hover:opacity-80 disabled:opacity-50"
          style={{
