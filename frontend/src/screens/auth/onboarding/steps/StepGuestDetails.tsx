...
interface Props { onSubmit: (d: GuestDetailsFormData) => Promise<void>; isLoading: boolean; }
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
      ...
      <div className="grid grid-cols-2 gap-4">
        <Input label="First name" placeholder="Ada" error={errors.firstName?.message} {...register("firstName")} />
        <Input label="Last name"  placeholder="Obi" error={errors.lastName?.message}  {...register("lastName")}  />
      </div>
      <Input label="Phone (optional)" placeholder="+2348012345678" error={errors.phone?.message} {...register("phone")} />
