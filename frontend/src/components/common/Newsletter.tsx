    ...
    <div className="flex w-full bg-[#151402]  py-20 items-center gap-8 justify-center">
      <div className="max-w-custom w-full">
        <div className="w-full flex flex-col gap-8">
          <h2 className="text-4xl flex-1 md:text-4xl  lg:text-7xl max-w-[750px] text-start leading-[1] family2 text-white family2">
            <AnimateTextWord type="bigtext">
              Spend your money and manage your finances stress-free
            </AnimateTextWord>
          </h2>
          <div className="flex flex-1 flex-col gap-4">
            <span className="text-xs lg:text-sm lg:text-smtext-[var(--grey-1)]  max-w-[500px]">
              <AnimateTextWord>
