  ...
  return (
    <div className="relative" ref={ref}>
      ...
      >
        ...
        <span className="text-base lg:text-base bold" style={{ color: "#17191c" }}>{displayValue}</span>
      </button>
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-80 bg-white border rounded-2xl shadow-xl z-30 p-5" style={{ borderColor: "#e8e6e3" }}>
          <div className="flex items-start justify-between mb-1">
            <div>
              <p className="text-sm bold" style={{ color: "#17191c" }}>Your Budget</p>
          ...
          <button
            ...
            className="w-full h-11 rounded-full text-sm bold text-white mt-4"
