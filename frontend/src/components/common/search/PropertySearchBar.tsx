    ...
    >
      <div className="flex items-center gap-2 bg-[#f2f0edb7] px-4 py-3 min-w-20 rounded-full">
        ...
        <input
          ...
          className="w-full text-sm lg:text-base bg-transparent h-14 outline-none placeholder:text-[#a3a6af]"
        />
      </div>
      ...
      <button
        ...
        className="flex min-w-32 items-center justify-center gap-2 h-14 lg:h-11 lg:rounded-full text-sm bold text-white shrink-0"
        style={{ backgroundColor: "var(--color-ink, #17191c)" }}
      >
        <SearchIcon size={15} />
        <span className="text-base lg:text-sm">Search</span>
      </button>
    </div>
  );
}