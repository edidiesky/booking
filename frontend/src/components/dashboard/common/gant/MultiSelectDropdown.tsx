      ...
      {open && (
        ...
        >
            ...
            <div className="px-2 pb-1.5 sticky top-0 bg-white">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full h-8 pl-7 pr-2 text-xs lg:text-sm rounded-lg border outline-none"
          ...
          {visibleOptions.map((opt) => (
            <label
              key={opt.value}
              className="flex items-center gap-2 text-xs lg:text-sm px-3 py-2 hover:bg-[#f2f0ed] cursor-pointer"
              style={{ color: "#17191c" }}
            >
          ...
          {visibleOptions.length === 0 && (
            <p className="text-xs lg:text-sm px-3 py-2" style={{ color: "#a3a6af" }}>
          ...
          {onSelectAll && options.length > 0 && (
            <>
              ...
              <button
                onClick={onSelectAll}
                className="text-xs lg:text-sm text-left px-3 py-1.5 hover:bg-[#f2f0ed]"
                style={{ color: "#777b86" }}
              >
