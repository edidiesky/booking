  ...
  return (
    <div className="flex items-center justify-between py-3 border-b last:border-0" style={{ borderColor: "#f2f0ed" }}>
      <div className="flex items-center gap-3">
        ...
        <span className="text-xs bold" style={{ color: "var(--color-ink)" }}>{label}</span>
      </div>
      {verified ? (
        <span className="text-xs bold px-2.5 py-1 rounded-full" style={{ backgroundColor: "#dcfce7", color: "#166534" }}>
          Verified
        </span>
      ) : (
        <button
          onClick={onVerify}
          disabled={verifying}
          className="text-xs bold px-3 py-1.5 rounded-full disabled:opacity-50"
    ...
    <div className="flex flex-col gap-3 p-4 rounded-xl border mt-3" style={{ borderColor: "#e8e6e3", backgroundColor: "#fafaf9" }}>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="h-10 px-4 rounded-lg text-xs bold disabled:opacity-50"
          style={{ backgroundColor: "var(--color-ink)", color: "var(--color-canvas)" }}
        >
          Confirm
        </button>
...
export default function SecurityPanel({ hasPhone }: { hasPhone: boolean }) {
  ...
  return (
    <div className="flex flex-col gap-8">
      <section>
        <p className="text-xs uppercase tracking-widest mb-3" style={{ color: "#a3a6af" }}>Verification</p>
      ...
      <section>
        ...
        <div className="rounded-xl border p-4 flex items-center justify-between" style={{ borderColor: "#e8e6e3" }}>
          ...
          <button
            ...
            className="text-xs bold px-3 py-1.5 rounded-full shrink-0"
            style={{
      ...
      <section>
        <p className="text-xs uppercase tracking-widest mb-3" style={{ color: "#a3a6af" }}>Transaction PIN</p>
        <div className="rounded-xl border p-4" style={{ borderColor: "#e8e6e3" }}>
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-xs bold px-3 py-1.5 rounded-full"
