      ...
      >
        <div className="flex items-center justify-between gap-3 px-5 py-5">
          <div className="flex items-center gap-3 min-w-0">
            <span
              className="w-11 h-11 rounded-full flex items-center justify-center text-xs lg:text-smlg:text-lg bold shrink-0"
                ...
                {group.items.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="text-xs lg:text-sm flex-1">{item.label}</span>
                      {item.badge}
