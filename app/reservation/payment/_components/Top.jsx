  ...
  return (
    <>
      <div className="w-full py-20 flex flex-col gap-24 justify-end items-end">
        <div className="w-[95%] relative md:w-[80%] mx-auto max-w-custom_2 justify-end items-end flex flex-col">
              ...
              <div className="flex flex-col gap-12 w-full">
                ...
                <div className="w-full flex flex-col gap-8">
                  <div className="w-full flex flex-col md:flex-row md:items-center gap-2">
                    <div className="w-12 md:-ml-8 h-12 bg-[#d8d8d8] rounded-full flex items-center justify-center text-3xl">
                      <BiChevronLeft/>
                    </div>
                    <h2
                      ref={ctaText_1}
                      className="text-5xl font-normal flex flex-wrap gap-x-[8px] gap-y-[8px]  leading-[1] font-booking_font3"
                    >
                ...
                <div className="w-full flex flex-col gap-8">
                  ...
                  <ul className="flex flex-col gap-4 pb-12 border-b">
                    <li className="text-base flex items-center gap-2 font-booking_font4 font-normal">
                ...
                <div className="w-full flex flex-col gap-4">
                  ...
                  <div className="btn p-6 cursor-pointer px-8 text-sm font-bold uppercase text-center rounded-lg text-white font-booking_font4">
                    pay now
                  </div>
                </div>
              </div>
