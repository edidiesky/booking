      ...
      {widgetData?.map((widget, index) => {
        return (
          <div
            ...
            className={`p-4 font-booking_font4 w-full rounded-[10px] hover:shadow-2xl justify-between cursor-pointer border grid bg-white items-center gap-4 h-48`}
          >
            <div className="flex flex-col">
              <h3 className="text-4xl font-bold font-booking_font_bold">
